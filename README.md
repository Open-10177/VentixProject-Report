...
Link de los repositorios de la organización: https://github.com/Open-10177


Link del repositorio-Informe: https://github.com/Open-10177/VentixProject-Report

#### Reporte de Colaboracion de la entrega del TB1:
...
**Geraldine Suarez Chinga**

**Jorge Francisco Taipe Sangama**

**Ruth YaniraSanchez Osorio**
...
- [1.3. Segmentos objetivos](https://github.com/Open-10177/VentixProject-Report/blob/main/docs/chapter-1.md#13-segmentos-objetivos)
...
- [2.4. Ubiquitous Language](https://github.com/Open-10177/VentixProject-Report/blob/main/docs/chapter-2.md#24-ubiquitous-language)
...
- [4.6. Domain-Driven Software Architecture](https://github.com/Open-10177/VentixProject-Report/blob/main/docs/chapter-4.md#46-domain-driven-software-architecture)
    - [4.6.1. Software Architecture Context Diagram](https://github.com/Open-10177/VentixProject-Report/blob/main/docs/chapter-4.md#461-software-architecture-context-diagram)
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Trabaja en equipo para proporcionar liderazgo en forma conjunta                                                                                     | **Geraldine Suarez Chinga** <br/> **TB1**: Contribui en el desarollo de la informacion y recoleccion de datos, ademas de interpretar las expectactivas de lo usuarios a traves de las diversas graficas,finalmente participe activamente en la colaboracion del grupo <br/><br/>**Jorge Francisco Taipe Sangama** <br/><br/>**TB1:** Presenté el diagrama de clases y la arquitectura del sistema en reuniones de equipo, adaptando el nivel de detalle según el perfil del público. Esto contribuyó a la integración de los componentes en la arquitectura general.<br/><br/>**Ruth YaniraSanchez Osorio** <br/><br/> Diseñé los diagramas, la arquitectura del sistema y la propuesta visual del aplicativo con su landing page, aportando la parte creativa que integró diseño y funcionalidad en la solución final. <br/><br/> **Albino Cáceres Pizarro** <br/><br/>**TB1**: Participé en la integración del Landing Page, realizando ajustes en la sección de servicios, testimonios y planes. También gestioné commits en GitHub (rama `develop`) y resolví conflictos de merge durante la integración de capítulos del documento. | Conclusión TB1:La comunicación oral fue clave para unificar criterios y garantizar que todos los integrantes comprendieran los objetivos del proyecto. Las presentaciones internas y discusiones guiadas permitieron consolidar decisiones de diseño y técnica de manera efectiva. |
| Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos                                                      | **Albino Cáceres Pizarro** <br/><br/>**TB1**: Se trabajó con ramas en GitHub (`main`, `develop`, `docs/chapter-*`) para organizar el desarrollo del proyecto.  <br/> <br/> **Suarez Chinga, Geraldine**<br/> <br/> **TB1**: Realizando rellenado de capitulos del proyecto, colabore grupalmente con la idea de como se crearia el producto y escuche las coordinaciones que recomendaban mis otros compañeros de equipo <br/> <br/> TB1: Presente partes del trabajo vital y colabore con diferentes software para que el trabajo se entegue a tiempo.  Esto contribuyó a la integración de los componentes en la arquitectura general.                                                                                                                                                                                                                                                                                                         |                                                                                                                                                                                                                                                                                    |
