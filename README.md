...
| Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos                                                      | **Albino Cáceres Pizarro** <br/><br/>**TB1**: Se trabajó con ramas en GitHub (`main`, `develop`, `docs/chapter-*`) para organizar el desarrollo del proyecto.    <br/> <br/> TB1: Presente partes del trabajo vital y colabore con diferentes software para que el trabajo se entegue a tiempo.  Esto contribuyó a la integración de los componentes en la arquitectura general.                                                                                                                                                                                                                                                                                                         |                                                                                                                                                                                                                                                                                    |
