...
Durante el Sprint 2, las métricas de colaboración registradas en GitHub muestran una contribución activa de todos los miembros del equipo al repositorio de VENTIX. La distribución de commits a lo largo del periodo evidencia un desarrollo incremental de las funcionalidades del sistema, incluyendo la interfaz responsive, el soporte bilingüe, la visualización y gestión de datos ambientales, la configuración de parámetros de monitoreo y el despliegue continuo en Azure Static Web Apps. Los registros de actividad demuestran que las tareas fueron ejecutadas de manera colaborativa mediante la implementación de nuevas funcionalidades, mejoras de interfaz, correcciones y validaciones continuas, favoreciendo una construcción conjunta y coordinada del producto.
...
<img src="../assets/img/chapter-5/overview_sprint3.png" alt="Overview" width="1000">
*Figura 62. Panel Overview de GitHub mostrando el flujo de commits de los integrantes del equipo durante el Sprint 3. Fuente: GitHub Analytics - Repositorio Open-10177/Ventix-Backend.*
...
**Figura 63. Network Graph del repositorio en GitHub**
<img src="../assets/img/chapter-5/network3.png" alt="ntwork" width="1000">
*Figura 63. Network Graph del repositorio Ventix-Backend en GitHub, evidenciando el flujo de ramas feature y su integración a main. Fuente: GitHub - Repositorio Open-10177/Ventix-Backend.*
...
**Figura 64. Gráfico de visitantes del repositorio en GitHub**
<img src="../assets/img/chapter-5/visitors3.png" alt="traffic" width="1000">
*Figura 64. Gráfico de Visitors del repositorio Ventix-Backend en GitHub, mostrando el incremento de visitas conforme avanzó el Sprint 3. Fuente: GitHub Insights - Repositorio Open-10177/Ventix-Backend.*
